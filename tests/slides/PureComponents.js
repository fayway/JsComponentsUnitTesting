...
var stripSpaces = require('../setup/utils').stripSpaces;
Ractive.DEBUG = false;
    ...
    var SUT = Ractive.extend({
        template: `
            <div>
                ...
                {{#if !user.email }}<div class="alert">Vous devez renseigner votre email</div>{{/if}}
            </div>
        `
    });
...
describe('Testing Behavior', function() {
    ...
    it('Doit déclencher un événement', function (done) {
